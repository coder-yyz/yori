...
const TESTIMONIALS = [
  ...
  },
  {
    ...
    avatarUrl: '',
    content:
      "It's a very good dashboard and we are really liking the product. We've done some things to fit our methodology but the product is one of the best in terms of design and application architecture.",
  },
  {
    name: 'David Kim',
    postedDate: '2023-04-19',
    ratingNumber: 5,
    avatarUrl: '',
    content:
      'Customer support is really fast and helpful. The design of this theme looks amazing and the code is very clean and readable. Really good job!',
  },
  {
    name: 'Emily Park',
  ...
  },
  {
    ...
    avatarUrl: '',
    content:
      'Got a few questions after purchasing the product. The owner responded very fast and was very helpful. Overall the code is excellent and works very well. 5/5 stars!',
  },
  {
    name: 'Chris Brown',
    ...
    avatarUrl: '',
    content:
      'We needed to provide an awesome dashboard for our early customers. I am super happy with the purchase. The code is just as good as the design. Thanks!',
  },
];
