    ...
    rules: {
      ...
      'perfectionist/sort-imports': [
        'warn',
        {
          ...
          customGroups: {
            value: {
              'custom-mui': ['^@mui/.+', '^@emotion/.+'],
              'custom-routes': ['^src/routes/.+'],
              'custom-hooks': ['^src/hooks/.+'],
              'custom-utils': ['^src/utils/.+', '^src/lib/.+'],
              'custom-components': ['^src/components/.+', '^src/layouts/.+', '^src/theme/.+'],
              'custom-sections': ['^src/pages/.+', '^src/actions/.+', '^src/http/.+'],
              'custom-auth': ['^src/auth/.+'],
              'custom-types': ['^src/types/.+', '^src/models/.+'],
            },
          },
        },
      ],
